...
public class SimpleApplication extends IsisWicketApplication {
    ...
    protected void init() {
        ...
        settings.setThemeProvider(new BootswatchThemeProvider(BootswatchTheme.Yeti));
    }
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(String.class).annotatedWith(Names.named("brandLogoHeader")).toInstance("../images/massa_logo_brand.png");
